-- =====================================================
-- COLLECTION MARKETPLACE INTEGRATION: Get my listings with progress
-- =====================================================
-- Purpose: Enable users to view their listings with template progress
-- Returns listings with sync information for template-linked listings
-- =====================================================

-- FUNCTION: get_my_listings_with_progress
-- Gets user's listings with optional template progress information
...
COMMENT ON FUNCTION get_my_listings_with_progress IS 'Gets user''s listings with optional template progress information';