-- =====================================================
-- OneSignal Integration: Push Notification Triggers
-- =====================================================
-- Purpose: Trigger Edge Function to send push notifications on new inserts
-- Date: 2025-11-26
-- =====================================================
...
BEGIN
    ...
    CASE NEW.kind
        ...
        ELSE
            ...
            v_body := 'Tienes una nueva actividad en Cromos';
    END CASE;
...
COMMENT ON FUNCTION send_push_notification_trigger() IS 'Triggers the send-push-notification Edge Function when a new notification is inserted.';
