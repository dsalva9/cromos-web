-- =====================================================
-- Apply Missing Listing Chat RPCs
-- =====================================================
-- This file contains the RPC functions needed for listing chats
...
-- Grant permissions
REVOKE ALL ON FUNCTION send_listing_message FROM PUBLIC;
REVOKE ALL ON FUNCTION get_listing_chats FROM PUBLIC;
REVOKE ALL ON FUNCTION get_listing_chat_participants FROM PUBLIC;
REVOKE ALL ON FUNCTION mark_listing_messages_read FROM PUBLIC;
