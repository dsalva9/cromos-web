-- Fix admin_purge_user to only delete from existing tables
-- Removed references to: trade_offers, messages, notification_preferences
...
BEGIN
    ...
    -- 8. Delete trade chats (before trade_proposals)
