-- =====================================================
-- Fix resolve_report to set suspended_at when suspending users
-- =====================================================
-- Issue: resolve_report sets is_suspended=TRUE but not suspended_at
--        admin_unsuspend_account checks for suspended_at IS NOT NULL
--        This causes "User is not suspended" error when trying to unsuspend
-- Fix: Set suspended_at, suspended_by, and suspension_reason when suspending
-- =====================================================
...
BEGIN
    ...
    IF p_action = 'remove_content' THEN
        IF v_report.target_type = 'listing' THEN
            ...
            -- Create retention_schedule entry
    ...
    ELSIF p_action = 'suspend_user' THEN
        ...
        -- Suspend the user with all required fields
        UPDATE profiles
