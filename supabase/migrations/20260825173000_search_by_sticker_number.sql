-- Migration: 20260825173000_search_by_sticker_number.sql
-- Description: Add sticker_number matching (exact, stripped #, and short ILIKE) and listing_pack_items matching to list_trade_listings_with_collection_filter
