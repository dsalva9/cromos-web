-- =====================================================
-- Fix resolve_report function type casting
-- =====================================================
-- Issue: Comparing BIGINT columns with TEXT target_id without casting
-- Fixed: Added explicit casting when comparing target_id with entity IDs
-- =====================================================
...
BEGIN
    ...
    ELSIF p_action = 'suspend_user' THEN
        ...
        PERFORM log_moderation_action(
            'suspend_user',
            'user',
            NULL,  -- Cannot convert UUID to BIGINT
            p_admin_notes,
            v_old_entity,
            v_new_entity
        );
