-- =====================================================
-- Add Deeplinks to Email and Push Notifications
-- =====================================================
-- Purpose: Add action_url to notification payloads for deeplinks
-- Date: 2025-12-16
-- =====================================================

-- Update send_email_notification_trigger to include action URLs
...
BEGIN
    ...
    CASE NEW.kind
        ...
        WHEN 'listing_reserved' THEN
            ...
            v_action_url := v_base_url || '/marketplace/reservations';
...
COMMENT ON FUNCTION send_email_notification_trigger() IS 'Triggers the send-email-notification Edge Function with deeplinks when a new notification is inserted.';

-- Update send_push_notification_trigger to include action URLs
...
COMMENT ON FUNCTION send_push_notification_trigger() IS 'Triggers the send-push-notification Edge Function with deeplinks when a new notification is inserted.';
