-- =====================================================
-- Add distance sorting to marketplace listings
-- =====================================================
-- Purpose: Extend list_trade_listings to include distance from viewer
-- =====================================================

-- FUNCTION: list_trade_listings_with_distance
-- Lists active marketplace listings with optional distance sorting
...
-- Grant permissions
GRANT EXECUTE ON FUNCTION list_trade_listings_with_distance TO anon, authenticated;

-- Add comment
COMMENT ON FUNCTION list_trade_listings_with_distance IS 'Lists active marketplace listings with optional distance-based sorting';
