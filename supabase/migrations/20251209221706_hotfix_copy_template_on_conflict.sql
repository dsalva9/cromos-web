-- =====================================================
-- HOTFIX: Fix copy_template ON CONFLICT error
-- =====================================================
-- Issue: ON CONFLICT error when copying templates
-- Root cause: Missing or incorrect search_path in functions
-- Fix: Ensure proper search_path and remove any incorrect ON CONFLICT clauses
-- =====================================================

-- Recreate copy_template function with proper search_path
...
COMMENT ON FUNCTION copy_template IS 'Copies a public template for the user (HOTFIX: Removed incorrect ON CONFLICT)';
