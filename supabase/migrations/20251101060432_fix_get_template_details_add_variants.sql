-- =====================================================
-- Fix get_template_details to include slot_variant and global_number
-- =====================================================
-- Purpose: Add missing Panini fields to template details RPC
-- =====================================================
...
BEGIN
    ...
    -- Get pages with slots (including slot_variant and global_number)
    SELECT json_agg(
        json_build_object(
            'id', tp.id,
...
-- Add comment
COMMENT ON FUNCTION get_template_details IS 'Gets detailed template information including pages and slots with variants and global numbers';
