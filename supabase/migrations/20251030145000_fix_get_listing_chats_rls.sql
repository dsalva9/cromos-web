-- =====================================================
-- Fix get_listing_chats to work with RLS for chat participants
-- =====================================================
-- Purpose: Allow chat participants to access messages even when
-- listing RLS would normally block access. Check chat participation
-- first, then verify listing exists.
-- =====================================================
...
COMMENT ON FUNCTION get_listing_chats IS 'Get chat messages for a listing - checks chat access first to work around RLS';
