-- Fix CASE type mismatch in list_public_templates function
...
BEGIN
    ...
    ORDER BY
        CASE
            ...
            WHEN p_sort_by = 'rating' THEN ct.created_at  -- Use timestamp as fallback
            WHEN p_sort_by = 'popular' THEN ct.created_at  -- Use timestamp as fallback
            ELSE ct.created_at
        END DESC,
        CASE
