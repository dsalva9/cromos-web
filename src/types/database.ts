  ...
  public: {
    Tables: {
      ...
      highlight_credit_transactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "highlight_credit_transactions_listing_id_fkey"
            columns: ["listing_id"]
            isOneToOne: false
            referencedRelation: "listings_with_template_info"
            referencedColumns: ["id"]
      ...
      listing_highlights: {
        ...
        Relationships: [
          {
            foreignKeyName: "listing_highlights_listing_id_fkey"
            columns: ["listing_id"]
            isOneToOne: false
            referencedRelation: "listings_with_template_info"
            referencedColumns: ["id"]
      ...
      listing_pack_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "listing_pack_items_listing_id_fkey"
            columns: ["listing_id"]
            isOneToOne: false
            referencedRelation: "listings_with_template_info"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "listing_pack_items_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
      ...
      marketplace_alert_matches: {
        ...
        Relationships: [
          {
            foreignKeyName: "marketplace_alert_matches_alert_id_fkey"
            columns: ["alert_id"]
            isOneToOne: false
            referencedRelation: "marketplace_alerts"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "marketplace_alert_matches_listing_id_fkey"
            columns: ["listing_id"]
            isOneToOne: false
            referencedRelation: "listings_with_template_info"
            referencedColumns: ["id"]
      ...
      marketplace_alerts: {
        ...
        Relationships: [
          {
            foreignKeyName: "marketplace_alerts_collection_id_fkey"
          ...
          {
            foreignKeyName: "marketplace_alerts_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
            referencedRelation: "collection_templates"
            referencedColumns: ["id"]
      ...
      trade_confirmations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "trade_confirmations_listing_id_fkey"
            columns: ["listing_id"]
            isOneToOne: false
            referencedRelation: "listings_with_template_info"
            referencedColumns: ["id"]
      ...
      user_feature_overrides: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_feature_overrides_flag_id_fkey"
            columns: ["flag_id"]
            isOneToOne: false
    ...
    Functions: {
      activate_highlight: {
        Args: { p_duration: string; p_listing_id: number }
        Returns: Json
      }
      ...
      admin_get_pending_deletion_expired_listings: {
        Args: never
        Returns: {
      ...
      admin_get_pending_reports_summary: {
        Args: { p_days?: number }
        Returns: {
          created_at: string
          description: string
      ...
      admin_stats_cohort_retention: {
        ...
        SetofOptions: {
          from: "*"
          to: "monthly_cohort_retention"
          isOneToOne: false
          isSetofReturn: true
        }
      }
      admin_stats_credits_obtained: {
        Args: { p_days?: number; p_since?: string }
        Returns: {
      ...
      admin_stats_google_play_clicks: {
        Args: { p_days?: number; p_since?: string }
        Returns: {
          click_count: number
          source: string
      ...
      admin_stats_marketplace_health: {
        Args: { p_country_code?: string }
        Returns: {
          active_listings: number
          archived_listings: number
      ...
      admin_toggle_featured_template: {
        Args: { p_featured: boolean; p_template_id: number }
        Returns: undefined
      }
      ...
      admin_update_featured_priority: {
        Args: { p_priority: number; p_template_id: number }
        Returns: undefined
      }
      ...
      check_feature_flag: { Args: { p_flag_id: string }; Returns: boolean }
      ...
      compute_cohort_retention: { Args: never; Returns: undefined }
      confirm_trade: { Args: { p_confirmation_id: number }; Returns: boolean }
      copy_template: {
      ...
      find_users_with_duplicate_slot: {
        Args: { p_copy_id: number; p_slot_id: number }
        Returns: {
          avatar_url: string
          distance_km: number
          match_user_id: string
      ...
      get_digest_alert_matches: {
        Args: { p_frequency: string }
        Returns: {
          alert_collection_name: string
          alert_id: number
          alert_search_query: string
          alert_slot_info: string
          alert_user_id: string
          channel_email: boolean
          channel_in_app: boolean
          channel_push: boolean
          listing_author_nickname: string
          listing_collection_name: string
          listing_created_at: string
          listing_id: number
          listing_image_url: string
          listing_sticker_number: string
          listing_title: string
        }[]
      }
      ...
      get_highlight_info: { Args: { p_listing_id: number }; Returns: Json }
