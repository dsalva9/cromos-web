...
export default function ProPage() {
      ...
      <div className="min-h-screen bg-[#111827] flex items-center justify-center p-4">
        <ModernCard>
          <ModernCardContent className="p-8 text-center">
            ...
            <h2 className="text-xl font-bold text-white mb-2">Inicia sesión para ver PRO</h2>
            <p className="text-gray-400 mb-6">Necesitas una cuenta para activar CambioCromos PRO.</p>
            <Button
  ...
  if (isPro) {
    return (
      <div className="min-h-screen bg-[#111827] p-4 pt-8">
        <div className="max-w-lg mx-auto">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-white mb-2">¡Eres PRO!</h1>
            <ProBadge size="md" className="mx-auto" />
            {expiresAt && (
              <p className="text-gray-400 mt-3">
                Activo hasta: <span className="text-white font-medium">{new Date(expiresAt).toLocaleDateString('es-ES', { day: 'numeric', month: 'long', year: 'numeric' })}</span>
              </p>
            )}
          </div>
          ...
          <ModernCard>
            <ModernCardContent className="p-6">
              <h3 className="text-white font-bold mb-4">Tus beneficios activos</h3>
              <div className="space-y-3">
                {benefits.map((b) => (
                  <div key={b.title} className="flex items-center gap-3">
                    <Check size={18} className="text-[#FFC000] shrink-0" />
                    <span className="text-gray-300 text-sm">{b.title}</span>
                  </div>
                ))}
              </div>
            </ModernCardContent>
  ...
  return (
    <div className="min-h-screen bg-[#111827] p-4 pt-8 pb-24">
      <div className="max-w-lg mx-auto">
        {/* Hero */}
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">CambioCromos <span className="text-[#FFC000]">PRO</span></h1>
          <p className="text-gray-400">La mejor experiencia para coleccionistas</p>
        </div>
        ...
        <ModernCard className="mb-6 border-[#FFC000]/30">
          <ModernCardContent className="p-6 text-center">
            ...
            <h3 className="text-white font-bold text-lg mb-1">Prueba gratis 7 días</h3>
            <p className="text-gray-400 text-sm mb-4">Sin tarjeta de crédito. Cancela cuando quieras.</p>
            <Button
            ...
            <p className="text-gray-500 text-xs mt-2">200 créditos de destacados incluidos</p>
          </ModernCardContent>
        </ModernCard>

        {/* Pricing Cards */}
        <h3 className="text-white font-bold text-center mb-4">O suscríbete</h3>
        <div className="grid grid-cols-2 gap-3 mb-6">
          ...
          >
            ...
            <p className="text-white font-bold text-xl">4,99€</p>
          ...
          >
            ...
            <p className="text-gray-400 text-xs mb-1">Anual</p>
            <p className="text-white font-bold text-xl">49,99€</p>
            <p className="text-gray-500 text-xs">/año (4,17€/mes)</p>
          </button>
        </div>
        ...
        <div className="mt-10 space-y-4">
          <h3 className="text-white font-bold text-center">Preguntas frecuentes</h3>
          {[
            ...
            <ModernCard key={q}>
              <ModernCardContent className="p-4">
                <h4 className="text-white font-bold text-sm mb-1">{q}</h4>
