    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center p-8 bg-white rounded-xl shadow-lg border border-red-100">
          <p className="text-red-500 text-xl mb-4 font-bold">Error: {error}</p>
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12">
          <div>
            <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tight mb-3 text-black">
              Mis Álbumes
            </h1>
          ...
          <div className="flex flex-wrap gap-3 w-full md:w-auto">
            <Link href="/templates" className="flex-1 md:flex-none">
              <Button
                variant="outline"
                className="w-full bg-white border-gray-300 text-gray-700 hover:bg-gray-50 h-12 px-6 shadow-sm"
              >
        ...
        {/* Templates Grid */}
        {copies.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 bg-white rounded-3xl border border-gray-200 border-dashed shadow-sm">
            <div className="bg-gray-100 p-4 rounded-full mb-6">
              <LayoutGrid className="h-12 w-12 text-gray-400" />
            </div>
            <h3 className="text-xl font-bold text-gray-900 mb-2">No tienes colecciones activas</h3>
            ...
            {copies.map(copy => {
              ...
              return (
                <Link key={copy.copy_id} href={`/mis-plantillas/${copy.copy_id}`} className="block h-full">
                  <div className="group relative bg-white border border-gray-200 rounded-2xl overflow-hidden hover:border-[#FFC000] transition-all duration-300 hover:shadow-xl hover:shadow-black/5 h-full flex flex-col">
                    {/* Top Gradient Bar */}
                    ...
                    <div className="p-6 flex flex-col flex-grow">
                      ...
                      <div className="mb-6">
                        <div className="flex justify-between items-start mb-2 gap-2">
                          <h3 className="text-xl font-bold text-gray-900 group-hover:text-black transition-colors line-clamp-1 leading-tight">
                            {copy.title}
                          </h3>
                          {isComplete && (
                      ...
                      <div className="space-y-3 mb-6">
                        <div className="flex justify-between text-sm font-bold">
                          ...
                          <span className={isComplete ? "text-green-600" : "text-black"}>{percentage}%</span>
                        </div>
                        <div className="h-3 bg-gray-100 rounded-full overflow-hidden ring-1 ring-black/5">
                          <div
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-6">
                        <div className="bg-gray-50 rounded-xl p-3 flex items-center justify-between border border-gray-100 group-hover:border-gray-200 transition-colors">
                          <div className="flex items-center gap-2">
                            <div className="p-1.5 bg-green-100 rounded-lg">
                              <Check className="w-4 h-4 text-green-600" />
                            </div>
                            <span className="text-[10px] md:text-xs text-gray-500 font-bold uppercase tracking-wider">Tengo</span>
                          </div>
                          <span className="font-bold text-gray-900 text-lg">{copy.completed_slots}</span>
                        </div>
                        ...
                        <div className="bg-gray-50 rounded-xl p-3 flex items-center justify-between border border-gray-100 group-hover:border-gray-200 transition-colors">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] md:text-xs text-gray-500 font-bold uppercase tracking-wider">Faltan</span>
                          </div>
                          <span className="font-bold text-gray-900 text-lg">{copy.total_slots - copy.completed_slots}</span>
                        </div>
                      </div>

                      {/* Action */}
                      <div className="mt-auto pt-4 border-t border-gray-100">
                        <div className="flex items-center justify-between text-sm font-black uppercase tracking-wide text-gray-400 group-hover:text-black transition-colors">
