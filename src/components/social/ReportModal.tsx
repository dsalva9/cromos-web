...
export function ReportModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="bg-gray-50 dark:bg-gray-800 border-2 border-black">
        <DialogHeader>
          <DialogTitle className="text-gray-900 dark:text-white">Denunciar Contenido</DialogTitle>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              rows={4}
              maxLength={500}
              className="bg-white dark:bg-gray-800 border-2 border-black text-gray-900 dark:text-white"
            />
