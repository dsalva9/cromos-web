            ...
            <div className="flex flex-row items-center gap-3">
                ...
                {isIOS && (
                    <div className="relative">
                        ...
                        {showTip && (
                            <div className="absolute top-full mt-2 left-1/2 -translate-x-1/2 bg-gray-900 text-white text-xs rounded-lg px-4 py-2.5 w-56 text-center shadow-lg z-50 animate-in fade-in slide-in-from-top-2 duration-200" dangerouslySetInnerHTML={{__html: t('iosInstructions').replace('<icon/>', '<svg class="w-3 h-3 inline -mt-0.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><polyline points="16 6 12 2 8 6"/><line x1="12" x2="12" y1="2" y2="15"/></svg>')}}>
