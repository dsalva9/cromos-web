...
export default function PWAInstallButton() {
    ...
    if (isInstalled) {
        return (
            <div className="inline-flex items-center gap-2 bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 rounded-lg px-4 h-12 text-xs font-medium">
    ...
    return (
        <div className="relative">
            <button
                ...
                className="inline-flex items-center gap-2.5 bg-black hover:bg-gray-800 text-white rounded-lg px-4 h-12 transition-colors cursor-pointer"
            >
                {/* Apple-style icon */}
                ...
                <div className="flex flex-col items-start leading-tight">
                    <span className="text-[9px] font-normal tracking-wide">Instalar como</span>
                    <span className="text-sm font-semibold -mt-0.5">App Web (PWA)</span>
                </div>
            </button>
            {showTip && (
