...
import { X, Zap, Bell, Sparkles } from 'lucide-react';
...
export function AndroidInstallFullscreenModal() {
    ...
    return (
        <div className="fixed inset-0 z-[300] flex flex-col justify-between bg-gradient-to-b from-slate-950 via-zinc-900 to-black text-white p-6 overflow-y-auto">
            ...
            {/* Content Area */}
            <div className="flex-1 flex flex-col items-center justify-center max-w-sm mx-auto my-auto py-4 relative z-10">
                {/* Floating Gold Collectible Card Pack */}
                ...
                <p className="text-sm text-center text-gray-300 px-4 mb-8">
                    {t('subtitle')}
                </p>
            ...
            {/* Action Buttons */}
            <div className="w-full max-w-sm mx-auto flex flex-col items-center gap-4 pb-4 relative z-10">
                <a
                    href={PLAY_STORE_URL}
                    target="_blank"
