    ...
    <ModernCard className="bg-white dark:bg-gray-800 border-2 border-black transition-all duration-200 hover:border-gold hover:shadow-2xl cursor-pointer h-full">
      <ModernCardContent className="p-6">
        ...
        <div className="space-y-3 mb-4">
          ...
          <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 border-2 border-black rounded-md">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-bold uppercase text-green-600 dark:text-green-400">
                {t('theyOffer')}
              </span>
            </div>
