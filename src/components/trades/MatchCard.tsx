...
export function MatchCard({ match, collectionId }: MatchCardProps) {
  ...
  const handleViewDetails = () => {
    router.push(
      `/trades/find/${match.match_user_id}?collectionId=${collectionId}`
    );
  };
  ...
  return (
    <ModernCard className="bg-white hover:scale-105 transition-all duration-300 cursor-pointer">
      <ModernCardContent className="p-6">
        ...
        <div className="flex items-center justify-center p-2 bg-gradient-to-r from-teal-50 to-cyan-50 rounded-lg mb-4">
        ...
        <Button
          ...
          className="w-full bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 text-white font-semibold rounded-xl transition-all duration-200"
        >
          Ver detalles
        </Button>
      </ModernCardContent>
