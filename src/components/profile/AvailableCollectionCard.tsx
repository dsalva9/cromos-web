...
export function AvailableCollectionCard({
  ...
  return (
    <ModernCard className="bg-white/70 backdrop-blur-sm hover:scale-105 hover:shadow-2xl hover:ring-1 hover:ring-white/30 transition-all duration-300 overflow-hidden border-2 border-dashed border-yellow-200/60 ring-1 ring-black/5 relative">
      {/* Left Accent Rail */}
