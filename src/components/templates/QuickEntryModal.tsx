          ...
          <div className="flex-1 overflow-y-auto bg-gray-50 rounded-xl border border-gray-200 p-4 shadow-inner">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-2 text-sm">
              {slots
                ...
                .slice(0, 20)
                .map(slot => (
                  <div key={slot.slot_id} className="flex justify-between items-center py-1 border-b border-gray-200 last:border-0 hover:bg-gray-100 px-2 rounded -mx-2 transition-colors">
                    <span className="text-gray-600 font-mono">
                      <span className="text-gray-400 mr-2">#{slot.global_number}</span>
