-- =====================================================
-- MARKETPLACE: Fix get_my_listings_with_progress type mismatch
-- =====================================================
-- Purpose: Cast trade_listings.id to TEXT for retention_schedule join
-- Fixes: operator does not exist: text = bigint
-- =====================================================
